document.addEventListener('DOMContentLoaded', () => {
    ...
    pasteBtn.addEventListener('click', async () => {
        try {
            ...
            // Optionally show a small toast or ignore if permissions are denied
        }
    });
    ...
    const resetUI = () => {
        ...
        // Disable input during processing? Nah, just leave them but they won't work while we wait
    };
    ...
    const showDownload = (downloadUrl) => {
        ...
        // Optional: After clicking download, reset the form after 3 seconds
